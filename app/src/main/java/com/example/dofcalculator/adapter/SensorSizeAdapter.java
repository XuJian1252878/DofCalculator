package com.example.dofcalculator.adapter;
...
import com.example.dofcalculator.activity.CustomCircleOfConfusionActivity;
import com.example.dofcalculator.activity.MainActivity;
...
public class SensorSizeAdapter extends RecyclerView.Adapter<SensorSizeAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(final ViewGroup parent, int viewType) {
        ...
        View sensorSizeItemView = LayoutInflater.from(mContext).inflate(R.layout.sensor_size_item, parent, false);
