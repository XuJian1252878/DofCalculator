...
//        });
        ...
        mDistanceWheel.setAdapter(new Wheel.WheelAdapter() {
            ...
            public String getItemText(int position) {
                return UtilManager.getInstance().getCompatDistanceText(mainActivity,
        ...
        mApertureWheel.setAdapter(new Wheel.WheelAdapter() {
            ...
            @Override
            public String getItemText(int position) {
                return UtilManager.getInstance().getApertureText(mainActivity,
        ...
        mFocalWheel.setAdapter(new Wheel.WheelAdapter() {
            ...
            @Override
            public String getItemText(int position) {
                return UtilManager.getInstance().getFocalText(mainActivity,
        ...
        mSensorSizeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(mainActivity, SensorSizeActivity.class);
